...
exports.Browsers = {
    ...
    iOS: (browser) => ['iOS', browser, '17.4.1'],
    safari: (browser) => ['Safari', browser, '17.4.1'],
...
/**
 * Detect if the current environment is iOS
 */
const isIOS = () => {
...
/**
 * Get appropriate browser configuration for iOS devices
 */
const getIOSBrowserConfig = () => {
    return exports.Browsers.iOS('Safari');
};
exports.getIOSBrowserConfig = getIOSBrowserConfig;

/**
 * Get appropriate browser configuration for Apple devices (iOS/macOS)
 */
const getAppleBrowserConfig = () => {
    if (exports.isIOS()) {
        return exports.getIOSBrowserConfig();
    }
    return exports.Browsers.macOS('Safari');
};
exports.getAppleBrowserConfig = getAppleBrowserConfig;
exports.BufferJSON = {
    replacer: (k, value) => {
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://unpkg.com/@@ajammm/baileys/baileys@1.0.5/lib/Defaults/baileys-version.json';
    try {
